...
/**
 @brief                 Deprecated! The reverb preset to be added to all sound sources
 @see                   IHSAudio3DReverbPreset
 @deprecated            These values have been renamed and are deprecated.
 */
typedef NS_ENUM(NSInteger, IHSAudioReverbPresetDepricated) {
    // Reverb off preset
